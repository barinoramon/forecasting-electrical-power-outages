...
from elt.repositories.ingestors.weather_ingestor import WeatherIngestor
...
class IngestorPipeline(Pipeline):
    def __init__(self):
        ...
        self.data_source = {
            ...
            'weather': self.data_lake.get_directory("raw\weather")
        }
    ...
    def ingest_weather_data(self):
        weather = WeatherIngestor(self.data_source['weather'].path)
        weather.ingest()
